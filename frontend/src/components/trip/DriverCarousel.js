...
const CATEGORY_LABEL = { economy: 'Economy', XL: 'XL', premium: 'Premium' };
const CATEGORY_STYLE = {
  economy: { backgroundColor: '#E8F5E9', borderColor: '#66BB6A' },
  XL:      { backgroundColor: '#E3F2FD', borderColor: '#42A5F5' },
  premium: { backgroundColor: '#FFF8E1', borderColor: '#FFA726' },
};
            ...
            >
              {driver.profilePic ? (
                <Image
                  ...
                  style={[
                    ...
                    styles.driverCardAvatarPhoto,
                    isSelected && styles.driverCardAvatarSelected,
                    isNearest && !isSelected && styles.driverCardAvatarNearest,
                  ]}
                />
              ) : (
                <View style={[
              ...
              <View style={styles.driverCardBody}>
                <View style={styles.driverNameRow}>
                  ...
                  {driver.category && (
                    <View style={[styles.categoryChip, CATEGORY_STYLE[driver.category]]}>
...
const styles = StyleSheet.create({
  ...
  driverCardAvatarPhoto: {
    borderWidth: 2, borderColor: COLORS.primary,
  },
  driverCardAvatarNearest: { borderColor: COLORS.primary },
  driverCardAvatarSelected: { borderColor: COLORS.success },
  ...
  categoryChipText: { fontSize: 10, fontWeight: '700', color: COLORS.dark },
});
